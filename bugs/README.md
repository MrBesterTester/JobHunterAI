...
**Last Updated**: 2025-10-31 08:59:56
...
- **Development machine showing 137GB available out of 932GB (15% free). Analysis shows primary contributors: Library/Caches (25GB), backend/target (5.5GB), and Time Machine snapshots.**: 1
- **backend**: 4
...
|----|-------|----------|-----------|---------|---------|
| BUG-0007 | [Refresh Descriptions Button Not Working](open/BUG-0007-refresh-descriptions-button-not-working.md) | medium | frontend | 2025-10-30 | 2025-10-30 |
| BUG-0008 | [E2E Tests for Unimplemented Phase 5 Features](open/BUG-0008-e2e-tests-for-unimplemented-phase-5-features.md) | low | frontend | 2025-10-30 | 2025-10-30 |
...
| ISSUE-027 | [Low disk space on development machine](open/ISSUE-027-low-disk-space-on-development-machine.md) | low-disk-space | Development machine showing 137GB available out of 932GB (15% free). Analysis shows primary contributors: Library/Caches (25GB), backend/target (5.5GB), and Time Machine snapshots. | 2025-10-31 | 2025-10-31 |
...
**Generated on**: 2025-10-31 08:59:56
